...
<Box sx={{ mt: [2, 2, 3], mb: [5,5,6] }}>

<Title text="Husbanding & Fathering" />

- Married to a wonderfully amazing and patient woman, named Sue.  
...
- SLDR 3 Wood 
- SLDR 3 Hybrid
- Cobra Amp Cell 4 Iron to Gap Wedge
- Rando 60 and 56 Wedges
...
- I went through a string of none development specific [jobs](https://linkedin.com/kenjdavidson) before getting back into development.  Since then I've mainly been working with `Java`, `AngularJS` and a little `React Native`.
- My first attempt at playing with React Native ended up in a releasing and maintaining the [React Native Bluetooth Classic](https://kenjdavidson.com/react-native-bluetooth-classic) library.
