...
- What's in the bag? SLDR Driver, SLDR 3 Wood, SLDR 3 Hybrid, Cobra Amp Cell 4 Iron to Gap Wedge and some rando 60 and 56 Wedges.
...
- In my current role I work with `Java`, `AngularJS`, `Jasper Reports`, a little `React Native`, with a sprinkle of `Drupal` starting to join in.
