...
- [my-foray-into-swift-streams](/writing/2019/06/02/my-foray-into-swift-streams)
- [async-component-did-wait-woes](/writing/2020/10/16/async-component-did-wait-woes)
...
This is where the _fun?_ began, there was a steady influx of issues and feature requests that started coming in, it was an exciting and (equally) aggravating time. Some solid feature and pull requests came in:
...
I do my best to provide as much information as possible; with regards to bugs, reasoning, etc. and it's painful to see issues getting opened with a line of text saying "_SOME ISSUE_ just doesn't work". What I would like to do (and this is super petty of me I know) is to be able to reverse open source some of these things.
...
I work 9-5 and have a 4 year old son and a wife doing her MBA. As much as I would love to have all the time in the world it's just not possible. I do my best to answer questions but I am starting to rely on the _kindness of strangers_ a little more with regards to this library. I've had some requests from people that just don't get that this is a side project - and expect the world from it (and me).
